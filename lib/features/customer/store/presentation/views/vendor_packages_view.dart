...
class CustomerVendorPackagesView extends StatefulWidget {
  const CustomerVendorPackagesView({
  ...
  @override
  State<CustomerVendorPackagesView> createState() => _CustomerVendorPackagesViewState();
}

class _CustomerVendorPackagesViewState extends State<CustomerVendorPackagesView> {
  @override
  void initState() {
    super.initState();
    context.read<CustomerStoreCubit>().getVendorPackagesById(
      ...
      body: BlocBuilder<CustomerStoreCubit, CustomerStoreState>(
        builder: (context, state) {
          ...
          return PaginatedBuilder<PackageModel>(
            ...
            onRefresh: () async {
              await context.read<CustomerStoreCubit>().getVendorPackagesById(
                    vendorId: widget.vendorId,
                  );
            },
            onLoadMore: () async {
