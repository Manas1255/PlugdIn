...
class CustomerVendorDetailsView extends StatelessWidget {
  const CustomerVendorDetailsView({super.key});

  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return BlocBuilder<CustomerStoreCubit, CustomerStoreState>(
