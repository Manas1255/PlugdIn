...
class _CustomerBrowseScreenState extends State<CustomerBrowseScreen> {
  ...
  void _fetchFilteredVendors() {
    final filterState = context.read<CustomerFilterCubit>().state;
    ...
    context.read<CustomerBrowseCubit>().fetchFilteredVendors(
      viewType: viewType,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: BlocBuilder<CustomerBrowseCubit, CustomerBrowseState>(
