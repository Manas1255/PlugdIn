...
class CaterersFilterView extends StatefulWidget {
  const CaterersFilterView({super.key});

  @override
  State<CaterersFilterView> createState() => _CaterersFilterViewState();
}

class _CaterersFilterViewState extends State<CaterersFilterView> {
  ...
  void initState() {
    super.initState();
    final state = context.read<CustomerFilterCubit>().state;
            ...
            children: [
              Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      context.read<CustomerFilterCubit>().updateViewType(
              ...
              PIDropdown<City>(
                ...
                onChanged: (city) {
                  _previousCity = city;
                  context.read<CustomerFilterCubit>().setCity(city);
                },
                  ...
                  Expanded(
                    child: PITextField(
                      ...
                      onChanged: (value) {
                        ...
                        context.read<CustomerFilterCubit>().setPriceFrom(
                          parsedValue,
                        );
                      },
                    ),
                  ...
                  Expanded(
                    child: PITextField(
                      ...
                      onChanged: (value) {
                        ...
                        context.read<CustomerFilterCubit>().setPriceTo(
                          parsedValue,
                        );
                      },
                    ),
              ...
              SliderTheme(
                ...
                child: RangeSlider(
                  ...
                  onChanged: (RangeValues values) {
                    context.read<CustomerFilterCubit>().setCapacityRange(
                      values.start.toInt(),
                      values.end.toInt(),
                    );
                  },
