...
class PhotographersFilterView extends StatefulWidget {
  const PhotographersFilterView({super.key});

  @override
  State<PhotographersFilterView> createState() => _PhotographersFilterViewState();
}

class _PhotographersFilterViewState extends State<PhotographersFilterView> {
