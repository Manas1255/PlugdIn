...
class VenuesFilterView extends StatefulWidget {
  const VenuesFilterView({super.key});

  @override
  State<VenuesFilterView> createState() => _VenuesFilterViewState();
}

class _VenuesFilterViewState extends State<VenuesFilterView> {
