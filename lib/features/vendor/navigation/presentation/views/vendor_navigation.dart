...
class VendorNavigation extends StatefulWidget {
  const VendorNavigation({required this.shell, super.key});
...
class _VendorNavigationState extends State<VendorNavigation> {
  ...
  List<NavItem> get _navBarItems => [
    ...
    const NavItem(
      title: 'Post',
      icon: AssetPaths.postIcon,
      selectedIcon: AssetPaths.postIcon,
    ),
    const NavItem(
      title: 'Store',
      icon: AssetPaths.storeUnselectedIcon,
      selectedIcon: AssetPaths.storeSelectedIcon,
    ),
    const NavItem(
      title: 'Profile',
