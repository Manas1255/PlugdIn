...
class AppRoutes {
  ...
  static const String vendorOnboardingSuccessScreen =
      '/vendor-onboarding-success-screen';
  ...
  static const String customerVendorStoreScreen =
      '/customer-vendor-store-screen';
