...
abstract class AppColors {
  ...
  static const redShade2 = Color(0xFFFF3B30);
  static const green = Color(0xFF00C252);
  ...
  static const tertiaryShade2 = Color.fromRGBO(35, 26, 42, 0.8);

  static const shadow = Color.fromRGBO(128, 48, 194, 0.13);
  static const sliderBackGround = Color.fromRGBO(35, 26, 42, 0.5);
  static const bottomSheetSubtitle = Color.fromRGBO(219, 218, 220, 1);
  static const bottomSheetBorder = Color.fromRGBO(52, 43, 59, 1);
  static const greenSuccess = Color(0xFF14B82C);
  static const amber = Color(0xFFFFBF00);

  static const error = Color(0xFFC23032);

  static const textFieldBorderColor = Color(0xFFEBEBEB);
  static const swipeTextGrey = Color(0xFFC3C1C5);
